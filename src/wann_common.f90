  ...
  !
  ! Additional variables for compatibility with PP pw2wannier90 interface
  !
  CHARACTER(LEN=256) :: seedname = 'wannier'
  LOGICAL :: write_eig = .TRUE.
  LOGICAL :: write_uhu = .FALSE.
  LOGICAL :: write_uIu = .FALSE.
  LOGICAL :: write_sHu = .FALSE.
  LOGICAL :: write_sIu = .FALSE.
  LOGICAL :: write_dmn = .FALSE.
  LOGICAL :: write_unkg = .FALSE.
  LOGICAL :: read_sym = .FALSE.
  LOGICAL :: irr_bz = .FALSE.
  LOGICAL :: reduce_unk = .FALSE.
  LOGICAL :: spn_formatted = .FALSE.
  LOGICAL :: uHu_formatted = .FALSE.
  LOGICAL :: uIu_formatted = .FALSE.
  LOGICAL :: sHu_formatted = .FALSE.
  LOGICAL :: sIu_formatted = .FALSE.
  INTEGER :: reduce_unk_factor = 1
  REAL(KIND=DP), ALLOCATABLE :: xk_all_w90(:,:)
  !-----------------------------------------------------------------------------------------
