Module edic_mod
  ...
  CHARACTER(LEN=256) :: defect_prefix = 'none'
  CHARACTER(LEN=256) :: defect_outdir = 'none'
  CHARACTER(LEN=256) :: pristine_prefix = 'none'
  CHARACTER(LEN=256) :: pristine_outdir = 'none'

  ! TF info
  REAL(dp) :: k0screen_read=-10.0_dp
  ...
  INTEGER :: nspin
  integer :: vac_idx=0
  REAL(dp) :: core_v_d=0.0_dp
  REAL(dp) :: core_v_p=0.0_dp
  ...
  NAMELIST / edicontrol / &
            ...
            defect_prefix, defect_outdir, pristine_prefix, pristine_outdir
